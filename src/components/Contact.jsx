...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_lrjw27w', // paste your ServiceID here (you'll get one when your service is created).
  ...
  return (
    <div
      ...
      <motion.div
        ...
        <p className={`mt-4 text-taupe text-[18px] leading-[30px]`} style={{paddingBottom:'30px'}}>
        Feel free to contact me via LinkedIn or email. I look forward to connecting with you, and I appreciate you taking the time to review my profile!</p>
