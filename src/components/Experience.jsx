...
<style>
    ...
    <div style={{height:'250px',overflowY: 'scroll',borderRadius:'0px', color:'rgba(244,244,246,1)'}} className='scrollable-div'  > 
      <h3 className=" text-[24px] font-bold font-beckman tracking-[2px]" style={{color:'rgba(244,244,246,1)'}}>
        {experience.title}
