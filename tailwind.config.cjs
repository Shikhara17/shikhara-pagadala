  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        experience:
          "linear-gradient(135deg, rgba(244,244,246,0.5) 100%, rgba(10,10,10,0.2) 0%),url('/src/assets/backgrounds/white-abstract.png')",
        experienceLight:
          'linear-gradient(137deg, rgba(244,244,246,0.5) 100%, rgba(10,10,10,0.9) 0%)',
        hero: 'linear-gradient(165deg, rgba(244,244,246,1)  100%, rgba(122,122,122,1) 100%)',
